      ...
      <div className="relative">
        ...
        {openProfileMenus && (
          <div className="bg-white py-4 flex flex-col gap-2 absolute right-2 w-[150px] rounded shadow text-sm">
            <p className="text-center w-full py-1 hover:bg-emerald-700 hover:text-white rounded-sm hover:cursor-pointer">
              <Link href="/dashboard/profile">Profile</Link>
            </p>
            <p
              className="text-center w-full py-1 hover:bg-emerald-700 hover:text-white rounded-sm hover:cursor-pointer"

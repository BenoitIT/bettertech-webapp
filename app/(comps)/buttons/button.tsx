...
export const BasicBtn = ({label}:any) => {
  return (
    <button
      type="button"
      className="text-white bg-gradient-to-r from-emerald-400 via-emerald-600 to-emerald-700 hover:bg-emerald-800  focus:outline-none  rounded text-sm px-5 py-2.5 text-center me-2 mb-2 w-full"
    >
      {label}
    </button>
  );
